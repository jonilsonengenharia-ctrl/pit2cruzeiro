...
// Pega as mensagens da sessão, se existirem, para exibir feedback
...
<div class="max-w-4xl mx-auto">
    ...
    <!-- Bloco para exibir mensagens de feedback (erro ou sucesso) -->
        ...
        <section class="md:col-span-2">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md mb-8">
                ...
                <div class="space-y-3">
                 ...
                 <a href="/editar_perfil.php" class="mt-4 inline-block text-sm text-pink-500 hover:underline font-medium">Editar Perfil</a>
                 <a href="/recuperar_senha.php" class="mt-4 ml-4 inline-block text-sm text-blue-500 hover:underline font-medium">Alterar Senha</a>
            </div>
